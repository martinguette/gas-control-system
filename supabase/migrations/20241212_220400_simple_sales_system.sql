-- =====================================================
-- MIGRACIÓN: Sistema de ventas simple
-- =====================================================
-- Fecha: 2024-12-12
-- Descripción: Crear sistema de ventas sin verificaciones complejas
-- =====================================================

-- Crear tabla para detalles de venta si no existe
...
-- Crear políticas RLS (usar IF NOT EXISTS no funciona con políticas)
DROP POLICY IF EXISTS "Vendedores pueden ver sus propios sale_items" ON sale_items;
...
DROP POLICY IF EXISTS "Vendedores pueden insertar sale_items" ON sale_items;
...
DROP POLICY IF EXISTS "Jefes pueden ver todos los sale_items" ON sale_items;
...
BEGIN
    ...
    RAISE NOTICE 'Migración completada exitosamente: Sistema de ventas simple';
END $$;
