-- =====================================================
-- MIGRACIÓN: Sistema de ventas final
-- =====================================================
-- Fecha: 2024-12-12
-- Descripción: Solo agregar lo que falta del sistema de ventas
-- =====================================================
...
DO $$
BEGIN
    -- Verificar si la política existe antes de crearla
    IF NOT EXISTS (
...
-- Agregar a Realtime solo si no está ya agregado
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Crear trigger para updated_at en sale_items solo si no existe
DO $$
BEGIN
    IF NOT EXISTS (
...
BEGIN
    ...
    RAISE NOTICE 'Migración completada exitosamente: Sistema de ventas final';
END $$;
