-- =====================================================
-- MIGRACIÓN: Rediseñar sistema de ventas
-- =====================================================
-- Fecha: 2024-12-12
-- Descripción: Soporte para múltiples tipos de cilindros por transacción
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE 'Migración completada exitosamente: Sistema de ventas rediseñado';
END $$;
